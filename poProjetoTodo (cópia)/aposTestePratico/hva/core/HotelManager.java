...
public class HotelManager {
  ...
  public void criar(String _fileName) throws TestePraticoException{
    if (_fileName.length() > 12) {
      throw new TestePraticoException();
    }
   ...
   * @throws IOException
   **/
  public void saveAs(String filename) throws FileNotFoundException, MissingFileAssociationException, IOException,UnknownEmployeeKeyException {
